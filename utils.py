...
class DataTransformer:
    ...
    def __init__(self, data: pd.DataFrame, feature_colname: list=[]):#data: dict()
        self.data = data
#         self.data_trans = data["tans"]
#         self.data_games = data["games"]
        self.feature_colname = feature_colname
        self.idx_true = None
        self.idx_false = None
#         self.ftmodel = ft.load_model("game_embedding_model_ep5.bin")
        self.__init_configuration()
        self.user_idx = self.data['trans_id']
        self.__init_predict()
...
#                 idx_min = self.data_trans[self.data[col] < scale_min].index
#                 idx_max = self.data_trans[self.data[col] > scale_max].index
...
#         transform_inputs_to_tensor=tf.convert_to_tensor(transform_inputs)
        ...
        return self.data#transform_inputs_to_tensor
